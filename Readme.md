...
O website foi desenvolvido pensando exatamente nessas necessidades e destina-se ao uso interno da lavanderia, oferecendo funcionalidades como:
...
* <h4> Cadastro de serviços disponibilizados pela empresa </h4>
	   O sistema também contará com a possibilidade de cadastramento de serviços realizados.
* <h4> Controle de entregas de produtos </h4>
		O software deverá auxiliar os colaboradores com as datas de entregas, e de saídas.

* <h4>  Controle de entregas de produtos </h4>
		O sistema deve auxiliar os funcionários com o controle de produtos que já foram/ serão recebidas pelos clientes.
...
* <h4> Front-End </h4>
A interface foi desenvolvida com foco em simplicidade e usabilidade. A equipe se dedicou à criação dos formulários e à estilização inicial, sempre buscando clareza e acessibilidade.

* <h4> Back-End </h4>
Decidimos utilizar PHP para desenvolver a lógica do sistema, aplicando os conhecimentos adquiridos em nossos estágios e experiências práticas para implementar as funcionalidades de maneira eficiente.

* <h4> Banco de Dados </h4>
Utilizamos MySQL, gerenciado através do PHPMyAdmin, o que proporcionou um ambiente funcional, estável e de fácil manutenção.
